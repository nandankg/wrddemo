...
it('allocation nav exposes dashboard, map, applications, licences, analytics in order', function () {
    assert_eq(['dashboard','map','applications','licences','analytics'], array_column(wrd_app('allocation')['nav'], 'key'));
});
